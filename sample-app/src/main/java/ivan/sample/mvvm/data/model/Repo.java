package ivan.sample.mvvm.data.model;
...
public class Repo implements Serializable {
    ...
    public Owner getOwner() {
        if (owner == null) {
            return new Gson().fromJson(ownerJson, Owner.class);
        } else {
            return owner;
        }
    }
    ...
    public void setOwner(Owner owner) {
        this.owner = owner;
        this.ownerJson = new Gson().toJson(owner);
    }
    ...
    public void setLicense(License license) {
        ...
        this.licenseJson = new Gson().toJson(license);
    }
    ...
    public void setOwnerJson(String ownerJson) {
